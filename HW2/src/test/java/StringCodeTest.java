...
public class StringCodeTest {
    ...
    public void testStringIntersect1() {
        assertEquals(true,StringCode.stringIntersect("kasbhisuujsa","ajhisuuauans",5));
    }

    @Test
    public void testStringIntersect2() {
        assertEquals(false,StringCode.stringIntersect("kasbhisuujsa","ajhiruuauans",5));
    }

    @Test
    public void testStringIntersect3() {
        assertEquals(true,StringCode.stringIntersect("123456","81y6124",2));
    }

    @Test
    public void testStringIntersect4() {
        assertEquals(false,StringCode.stringIntersect("fda","fdasqxcs",5));
    }

    @Test
    public void testStringIntersect5() {
        assertEquals(false,StringCode.stringIntersect("fda836hays","fda",5));
    }
}
